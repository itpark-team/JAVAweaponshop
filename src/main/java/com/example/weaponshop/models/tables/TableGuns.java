...
public class TableGuns {
    ...
    public ArrayList<Gun> getAll() throws Exception {
        ...
        try {
            ...
            String query = String.format("SELECT * FROM guns ORDER BY id");
            ...
            throw new Exception("Ошибка получения записей из базы данных: " + e.getMessage());
        } finally {
            if (connection != null) {
                connection.close();
            }
    ...
    public Gun getById(int id) throws Exception {
        ...
        try {
            ...
            if (resultSet.next() == true) {
                ...
                throw new Exception("Ошибка, элемента с таким id не существует");
            }
    ...
    public void insertOne(Gun gun) throws Exception {
        ...
        try {
            ...
            throw new Exception("Ошибка добавления записи в базу данных: " + e.getMessage());
        } finally {
            if (connection != null) {
                connection.close();
            }
    ...
    public void deleteById(int id) throws Exception {
        ...
        try {
            ...
            throw new Exception("Ошибка удаления записи: " + e.getMessage());
        } finally {
            if (connection != null) {
                connection.close();
            }
    ...
    public void updateById(int id, Gun gun) throws Exception {
        ...
        try {
            ...
            throw new Exception("Ошибка обновления записи: " + e.getMessage());
        } finally {
            if (connection != null) {
                connection.close();
            }
